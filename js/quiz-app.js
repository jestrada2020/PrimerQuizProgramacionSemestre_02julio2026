...
(() => {
    ...
    <div class="screen-login">
      <div class="card login-card">
        <div class="login-header">
          <div class="logo">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="96" height="96" aria-label="Logo pensamiento crítico e IA">
              <circle cx="50" cy="50" r="46" fill="none" stroke="#3B82F6" stroke-width="4"/>
              <circle cx="50" cy="32" r="10" fill="#3B82F6"/>
              <path d="M30 60 Q50 42 70 60" stroke="#8B5CF6" stroke-width="5" fill="none" stroke-linecap="round"/>
              <circle cx="30" cy="66" r="6" fill="#8B5CF6"/>
              <circle cx="70" cy="66" r="6" fill="#8B5CF6"/>
              <path d="M50 42 L50 78" stroke="#3B82F6" stroke-width="4" stroke-linecap="round"/>
            </svg>
          </div>
          <div class="title-row">
            <h1>Primer Quiz: Pensamiento Crítico e IA, y conceptos básicos de Python</h1>
            <svg class="python-badge" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 110 110" aria-label="Python logo">
              <path d="M54 10
                C36 10 28 18 28 30
                L28 42 54 42 54 46
          ...
          <p class="subtitle">Basado en las conferencias de A. Masferrer y J. I. Latorre</p>
          <p class="subtitle">40 Preguntas — 50 Puntos</p>
        </div>
        <form id="login-form" class="login-form" novalidate>
          ...
          <button type="submit" class="btn btn-primary btn-lg">Iniciar Primer Quiz →</button>
        </form>
      </div>
    </div>`;
  }
    ...
    <div class="screen-quiz">
      ...
      <header class="quiz-header">
        <div class="header-left">
          <span class="header-title">Primer Quiz: Pensamiento Crítico e IA</span>
  ...
  function renderResult() {
    ...
    const resultLogo = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="96" height="96" aria-label="Logo pensamiento crítico e IA">
              <circle cx="50" cy="50" r="46" fill="none" stroke="#3B82F6" stroke-width="4"/>
              <circle cx="50" cy="32" r="10" fill="#3B82F6"/>
              <path d="M30 60 Q50 42 70 60" stroke="#8B5CF6" stroke-width="5" fill="none" stroke-linecap="round"/>
              <circle cx="30" cy="66" r="6" fill="#8B5CF6"/>
    ...
    <div class="screen-result">
      <div class="result-card">
        <div class="result-emoji">${resultLogo}</div>
        <h1>Primer Quiz Completado</h1>
        ...
        <button id="btn-restart" class="btn btn-secondary">↺ Nuevo Quiz</button>
      </div>
    </div>`;
  }
